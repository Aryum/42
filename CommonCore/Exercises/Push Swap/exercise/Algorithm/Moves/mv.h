...
//push
void	mv_pushto_a(t_stack_data data);

void	mv_pushto_b(t_stack_data data);

//rotate
void	mv_rotate_a(t_stack_data data);

void	mv_rotate_b(t_stack_data data);

void	mv_rotate_both(t_stack_data data);
